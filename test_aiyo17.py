...
# from https://github.com/playone/forpython/blob/master/Newbie/test14.py
"""
排序
...
student_object.append(student('peter', 'C', 10))
student_object.append(student('fred', 'A', 12))
...
student_object.sort(key=attrgetter('grade', 'age'), reverse=False)
for i in student_object:
    print (i.name, i.grade, i.age)

print()

student_object.sort(key=attrgetter('age', 'grade'), reverse=True)
for i in student_object:
    print (i.name, i.grade, i.age)
